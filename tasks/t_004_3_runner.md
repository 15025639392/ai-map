...
```text
你现在扮演 qa_engineer_lead，负责实现任务 T-004-3。
...
```text
你现在扮演 Reviewer，对任务 T-004-3 做发布前审查。
...
```text
你现在扮演 QA 验收工程师，仅根据验收标准判断任务 T-004-3 是否通过。
