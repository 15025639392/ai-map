...
```json
{
  ...
  "story_id": "S-001-1",
  "epic_id": "E-001",
  "task_goal": "完成 WebGL2 渲染主循环与资源生命周期管理",
  "owner_role": "graphics_engineer",
  "development_executor": "graphics_engineer_lead",
  "estimate_days": 8,
  "acceptance_criteria": [
...
```text
你现在扮演 graphics_engineer_lead，负责实现任务 T-001-1。
...
```text
你现在扮演 Reviewer，对任务 T-001-1 做发布前审查。
...
```text
你现在扮演 QA 验收工程师，仅根据验收标准判断任务 T-001-1 是否通过。
