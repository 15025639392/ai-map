...
```json
{
  ...
  "story_id": "S-004-1",
  "epic_id": "E-004",
  "task_goal": "完成压力测试场景（15k QPS/8h 稳定性）",
  "owner_role": "qa_engineer",
  "development_executor": "qa_engineer_lead",
  "estimate_days": 9,
  "acceptance_criteria": [
...
```text
你现在扮演 qa_engineer_lead，负责实现任务 T-004-2。

【任务信息】
- epic/story: E-004/S-004-1
- owner_role: qa_engineer
- estimate_days: 9
- task_goal: 完成压力测试场景（15k QPS/8h 稳定性）

【边界与约束】
- 允许修改：tests/**, scripts/**, ci/**
- 禁止修改：src/index.ts
...
```text
你现在扮演 Reviewer，对任务 T-004-2 做发布前审查。
...
```text
你现在扮演 QA 验收工程师，仅根据验收标准判断任务 T-004-2 是否通过。
