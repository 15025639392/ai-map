...
```json
{
  ...
  "story_id": "S-004-1",
  "epic_id": "E-004",
  "task_goal": "建立渲染 golden image 回归框架",
  "owner_role": "qa_engineer",
  "development_executor": "qa_engineer_lead",
  "estimate_days": 8,
  "acceptance_criteria": [
...
```text
你现在扮演 qa_engineer_lead，负责实现任务 T-004-1。
...
```text
你现在扮演 Reviewer，对任务 T-004-1 做发布前审查。
...
```text
你现在扮演 QA 验收工程师，仅根据验收标准判断任务 T-004-1 是否通过。
