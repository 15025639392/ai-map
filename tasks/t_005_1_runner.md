...
```text
你现在扮演 devops_engineer_lead，负责实现任务 T-005-1。
...
```text
你现在扮演 Reviewer，对任务 T-005-1 做发布前审查。
...
```text
你现在扮演 QA 验收工程师，仅根据验收标准判断任务 T-005-1 是否通过。
