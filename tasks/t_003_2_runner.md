...
```json
{
  ...
  "story_id": "S-003-1",
  "epic_id": "E-003",
  "task_goal": "完成 MVT/栅格/地形瓦片生成与版本化",
  "owner_role": "backend_engineer",
  "development_executor": "backend_engineer_lead",
  "estimate_days": 12,
  "acceptance_criteria": [
...
```text
你现在扮演 backend_engineer_lead，负责实现任务 T-003-2。
...
```text
你现在扮演 Reviewer，对任务 T-003-2 做发布前审查。
...
```text
你现在扮演 QA 验收工程师，仅根据验收标准判断任务 T-003-2 是否通过。
